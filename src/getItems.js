...
async function getItems(pageObj, pageData, resultsArr, type) {
    if (type === 'NEW') {
...
async function scrapeDetailsPage(pageObj, pageData, type) {
    const resultsArr = [];
    // Scrape page 1
    await getItems(pageObj, pageData, resultsArr, type);
